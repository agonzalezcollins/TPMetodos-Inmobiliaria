...
/**
 * JTextField que solo ingresa alfanumericos
 * @author Agu
 */
public final class JTextFieldAlfanumerico extends JTextField 
{
	 ...
	 * @param cols
	 */
	public JTextFieldAlfanumerico(int cols, int limite) {
		super(cols);
	...
	protected Document createDefaultModel()	{
		return new JTextFieldAlfanumerico.AlfanumericoDocument();
	}

	/**
	 * Clase: Modelo de Documento para Alfanumericos
	 * 
	 * @author Agu
	 *
	 */
	private static class AlfanumericoDocument extends PlainDocument {
        private static final long serialVersionUID = 1L;
        ...
        public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
			...
			for (int i = 0 ; i < entrada.length; i++) {
                ...
                else if (Character.isDigit(entrada[i]))
