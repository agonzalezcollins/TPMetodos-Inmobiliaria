 ...
 * @author Agu
 */
public final class JTextFieldNumerosNaturales extends JTextField 
{
	private static final long serialVersionUID = 1L;

	private final static int NUMERO_MAX_COLUMNAS = 10;
	private final static int NUMERO_MAX_CARACTERES = 5;
	 ...
	 * 
	 */
	public JTextFieldNumerosNaturales(){	
	 ...
	 * @param cols
	 */
	public JTextFieldNumerosNaturales(int cols, int limite) {
		super(cols);
	...
	/**
	 * Clase: Modelo de Documento para Numeros Naturales
	 * 
	 * @author Agu
	 *
	 */
	static class NumDocument extends PlainDocument {
		...
		public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
			...
			for (int i = 0 ; i < entrada.length; i++) { // paso todo a mayus
